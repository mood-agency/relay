...
>(({ className, sideOffset = 4, collisionPadding = 8, ...props }: React.ComponentPropsWithoutRef<typeof TooltipPrimitive.Content>, ref: React.ForwardedRef<React.ElementRef<typeof TooltipPrimitive.Content>>) => (
