        ...
        <div className={tableStyles.TABLE_CONTAINER}>
            {hasFilterProps && (
                ...
                >
                    ...
                    {/* Date Range */}
                    <div className={tableStyles.FILTER_BAR_ITEM}>
                        <span className={tableStyles.FILTER_LABEL}>Created:</span>
                        <DateTimePicker
                            date={startDate}
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className={tableStyles.TABLE_ROW_HEADER}>
                                ...
                                <SortableHeader label="Created At" field="created_at" currentSort={sortBy} currentOrder={sortOrder} onSort={onSort} className="w-[180px]" />
